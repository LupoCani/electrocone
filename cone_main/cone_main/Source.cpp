...
void main()
{
	...
	float df, s, t, u, d, i, j;
	vector<float> p(10), p1(10), rd(10), r1(10);
	...
	while (1)
	{
		...
		{
			b[1].plot3d(r1[1]  *  cos(i * M_PI / 180.0), r1[1]  *  sin(i * M_PI / 180.0), 0, 10);
			b[2].plot3d(r1[2]  *  cos(i * M_PI / 180.0), r1[2]  *  sin(i * M_PI / 180.0), 0, 7);
			b[3].plot3d(r1[3]  *  cos(i * M_PI / 180.0), r1[3]  *  sin(i * M_PI / 180.0), 0, 6);
			b[4].plot3d(r1[4]  *  cos(i * M_PI / 180.0), r1[4]  *  sin(i * M_PI / 180.0), 0, 7);
			// b[5].plot3d(r1[5] * cos(i * M_PI/180.0),r1[5] * sin(i * M_PI/180.0),0,4);
			// b[6].plot3d(r1[6] * cos(i * M_PI/180.0),r1[6] * sin(i * M_PI/180.0),0,3);
		}
